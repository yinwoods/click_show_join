...
alter table click add partition(d='${hiveconf:date}', h='${hiveconf:hour_left5}') location 'wasb://niphdbr@nipspark.blob.core.windows.net/dailyCtr/NewsClickSummary-${hiveconf:date}/${hiveconf:hour_left5}';
alter table click add partition(d='${hiveconf:date}', h='${hiveconf:hour_left4}') location 'wasb://niphdbr@nipspark.blob.core.windows.net/dailyCtr/NewsClickSummary-${hiveconf:date}/${hiveconf:hour_left4}';
alter table click add partition(d='${hiveconf:date}', h='${hiveconf:hour_left3}') location 'wasb://niphdbr@nipspark.blob.core.windows.net/dailyCtr/NewsClickSummary-${hiveconf:date}/${hiveconf:hour_left3}';
alter table click add partition(d='${hiveconf:date}', h='${hiveconf:hour_left2}') location 'wasb://niphdbr@nipspark.blob.core.windows.net/dailyCtr/NewsClickSummary-${hiveconf:date}/${hiveconf:hour_left2}';
